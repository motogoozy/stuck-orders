  ...
  const expeditedOptions = () => {
    return filterOptions.expedited.map(option => (
      <option key={option.toString()} value={option.toString()}>
        {option === true ? 'Expedited' : 'Standard'}
      </option>
    ));
  };
        ...
        {orderData && filterOptions && (
          <div className='details-view-header-right-container'>
            ...
            <input
              ...
              type='text'
              placeholder='Search client, order number, phone'
            />
          </div>
        )}
      </div>
      {orderData && filterOptions ? (
        <div className='details-table'>
          <div className='details-table-header'>
            <p onClick={() => handleSort('client')} className='detail-client'>
              Client
            </p>
            <p onClick={() => handleSort('order_number')} className='detail-order-number'>
              Order Number
            </p>
            <p onClick={() => handleSort('expedited')} className='detail-expedited'>
              Expedited
            </p>
            ...
            <p onClick={() => handleSort('service_number')} className='detail-service-number'>
              Service Number
            </p>
            <p onClick={() => handleSort('order_type')} className='detail-order-type'>
              Order Type
            </p>
            <p onClick={() => handleSort('make')} className='detail-make-model'>
              Make / Model
            </p>
            <p onClick={() => handleSort('carrier')} className='detail-carrier'>
              Carrier
            </p>
            <p onClick={() => handleSort('notes')} className='detail-notes'>
              Notes
            </p>
          </div>
          <div className='details-table-filter-row'>
            ...
            <div className='detail-expedited'>
              <select
                name='expedited-filter'
                id='expedited-filter'
                value={filters.expedited}
                onChange={e => setFilters({ ...filters, expedited: e.target.value })}
              >
                <option value='' disabled defaultValue>
                  Filter
                </option>
            ...
            <div className='detail-status-age'>
              <select
                name='status-age-filter'
                id='status-age-filter'
                value={filters.status_age}
                onChange={e => setFilters({ ...filters, status_age: e.target.value })}
              >
                <option value='' disabled defaultValue>
                  Filter
                </option>
            ...
            <div className='detail-approval-order'>
              <select
                name='approval-age-filter'
                id='approval-age-filter'
                value={filters.approval_age}
                onChange={e => setFilters({ ...filters, approval_age: e.target.value })}
              >
                <option value='' disabled defaultValue>
                  Filter
                </option>
          ...
          <div className='details-table-body'>{displayRows()}</div>
        </div>
      ) : (
