...
import './ApprovedOrdersByClientPanel.scss';
import { formatClient } from '../../../utils/stuckOrdersUtils';

import { useHistory } from 'react-router-dom';
import { ResponsiveBar } from '@nivo/bar';

export default function ApprovedOrdersByClientPanel(props) {
  ...
  return (
    <ResponsiveBar
      ...
      data={props.approvedOrdersByClient.map(client => formatClient(client))}
